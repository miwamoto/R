...
For our initial model, our explanatory variables are `npvis`  - number for primary care visits, `cigs`  - number of cigarettes smoked per day and `drink` - average number of drinks per week. 
...
For all three models, We make the weak assumption that there is linearity in the parameters and use the linear regression model.
