...
bptest(model1)
```
Interestingly, with a p-value of 0.1076, we cannot reject the null hypothesis of homoskedasticity.  However, given the observed borderline statistical significance and evaluation of the residuals verses fitted plot, we choose to use robust standard error.
