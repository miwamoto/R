...
In the following analysis, we excluded any mothers under the age of 18 and over the age of 35, as there are widely known health complications within these ages. It's important to note that because of this restriction, our models provided are for babies with mothers over age 18 and under age 35 only. These may vary for mothers outside these age ranges, but executing the models this way mitigated the risk of having mothers in our dataset whose baby scores were more of a factor of their age than the amount of prenatal care they received. We also only included complese cases from the sample, so that unknown variables of bad data would not impact our regression.
